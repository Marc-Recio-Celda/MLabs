...
>
> **A change here calls for two reviews:** `company-auditor:A5` — *does this clause belong at this
> level* — and the review over every axiom in every department that `AXIOMS.md` already requires.
>
